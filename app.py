...
def get_co2_emissions():
    ...
    result = [{'country': row[0], 'year': row[2], 'emissions': row[3]} for row in data]
...
def get_temperature():
    ...
    # Convert the data to a dictionary format
    result = [{'country': row[0], 'year': row[2], 'temperature': row[3]} for row in data]
...
def compare_co2_emissions():
    ...
    # Convert the data to a dictionary format
    result = [{'country': row[0], 'year': row[1],'total_emissions': row[2]} for row in data]
...
@app.route('/temperature_co2')
def temp_co2():
    country_name = request.args.get("country")
    
    # Query -- average temperature per season per year
    query = text("SELECT co2_emissions.entity AS country, co2_emissions.year, co2_emissions.emissions,"
                 "(temp_mo_1901_2021.jan_temp + temp_mo_1901_2021.feb_temp + temp_mo_1901_2021.mar_temp + "
                 "temp_mo_1901_2021.apr_temp + temp_mo_1901_2021.may_temp + temp_mo_1901_2021.jun_temp + "
                 "temp_mo_1901_2021.jul_temp + temp_mo_1901_2021.aug_temp + temp_mo_1901_2021.sep_temp + "
                 "temp_mo_1901_2021.oct_temp + temp_mo_1901_2021.nov_temp + temp_mo_1901_2021.dec_temp) / 12 AS avg_temperature "
                 "FROM co2_emissions "
                 "JOIN temp_mo_1901_2021 ON co2_emissions.entity = temp_mo_1901_2021.country "
                 "AND co2_emissions.year = temp_mo_1901_2021.year "
                 "WHERE co2_emissions.entity = :country_name "
                 "ORDER BY co2_emissions.entity, co2_emissions.year")
    # query = f"SELECT co2_emissions.entity AS country, co2_emissions.year, co2_emissions.emissions,\
    #                 (temp_mo_1901_2021.jan_temp + temp_mo_1901_2021.feb_temp + temp_mo_1901_2021.mar_temp + temp_mo_1901_2021.apr_temp + temp_mo_1901_2021.may_temp + temp_mo_1901_2021.jun_temp + temp_mo_1901_2021.jul_temp + temp_mo_1901_2021.aug_temp + temp_mo_1901_2021.sep_temp + temp_mo_1901_2021.oct_temp + temp_mo_1901_2021.nov_temp + temp_mo_1901_2021.dec_temp) / 12 AS avg_temperature\
    #         FROM co2_emissions\
    #         JOIN temp_mo_1901_2021 ON co2_emissions.entity = temp_mo_1901_2021.country AND co2_emissions.year = temp_mo_1901_2021.year\
    #         WHERE country = {country_name}\
    #         ORDER BY co2_emissions.entity, co2_emissions.year;"
    data = engine.execute(query, country_name=country_name)

    # Convert the data to a dictionary format
    result = [{'Year': row[1], 'Country': row[0], 'co2_emissions':round((row[2]/1000000),2), 'avg_temperature':round((row[3]),2)} for row in data]
